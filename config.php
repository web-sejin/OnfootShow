...
define('G5_SMTP_USER', "onfut90@gmail.com");
define('G5_SMTP_PW',        'gqhkowggafeezamb');
...
//구장 인원
$_cfg['stadium']['to'] = array(
	array("val" => "4", "txt" => "4:4이하"),
	array("val" => "5", "txt" => "5:5"),
	array("val" => "6", "txt" => "6:6"),
	array("val" => "7", "txt" => "7:7이상"),
);

//구장 종류
$_cfg['stadium']['sort'] = array(
	array("val" => "1", "txt" => "실내"),
	array("val" => "2", "txt" => "실외"),
);

//바닥재
$_cfg['stadium']['floor'] = array(
	array("val" => "1", "txt" => "인조잔디"),
	array("val" => "2", "txt" => "인도어"),
);

//매치레벨
$_cfg['match']['level'] = array(
	array("val" => "1", "txt" => "최하"),
	array("val" => "2", "txt" => "하"),
	array("val" => "3", "txt" => "중"),
	array("val" => "4", "txt" => "상"),
...
//연령대
$_cfg['match']['age'] = array(
	array("val" => "1", "txt" => "10대"),
	array("val" => "2", "txt" => "20~25"),
	array("val" => "3", "txt" => "25~30"),
	array("val" => "4", "txt" => "30~35"),
	array("val" => "5", "txt" => "35이상"),
);

//성별
$_cfg['match']['gender'] = array(
	array("val" => "1", "txt" => "남자"),
	array("val" => "2", "txt" => "여자"),
	array("val" => "3", "txt" => "혼성"),
);

$cfg['kakao_key'] = "7eee3c733c296fdd3a0ef278d0495048";